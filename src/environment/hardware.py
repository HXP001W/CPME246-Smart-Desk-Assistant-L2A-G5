...
class HardwareController:
    def __init__(self):
        ...
        # 传感器初始化
        self.light_sensor = LightSensor(18)  # 光敏电阻：GPIO18对应物理引脚12
        self.temp_sensor = DigitalInputDevice(4)  # NTC温敏电阻：GPIO4对应物理引脚7
